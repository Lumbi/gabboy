...
-(void)test_LD_A_L {
    Gameboy gameboy;
    std::array<Byte, 1> program = { 0x7D };
    gameboy.memory.load_rom(program);
    gameboy.cpu.register_L = 0xAB;
    gameboy.run(2);
    XCTAssertEqual(gameboy.cpu.register_A, 0xAB);
    XCTAssertEqual(gameboy.cpu.program_counter, 2);
}
...
-(void)test_ADD_A_iHL_Z0 {
    Gameboy gameboy;
    std::array<Byte, 1> program = { 0x86 };
    gameboy.memory.load_rom(program);
    gameboy.cpu.register_A = 0x02;
    gameboy.cpu.register_H = 0xC0;
    gameboy.cpu.register_L = 0xAB;
    gameboy.memory.write(0xC0AB, 0x86);
    gameboy.run(3);
    XCTAssertEqual(gameboy.cpu.register_A, 0x88);
    XCTAssertEqual(gameboy.cpu.flag_Z, 0);
    XCTAssertEqual(gameboy.cpu.flag_N, 0);
    XCTAssertEqual(gameboy.cpu.flag_H, 1);
...
-(void)test_ADD_A_iHL_Z1 {
    Gameboy gameboy;
    std::array<Byte, 1> program = { 0x86 };
    gameboy.memory.load_rom(program);
    gameboy.cpu.register_A = 0xFE;
    gameboy.cpu.register_H = 0xC0;
    gameboy.cpu.register_L = 0xAB;
    gameboy.memory.write(0xC0AB, 0x02);
    gameboy.run(3);
    XCTAssertEqual(gameboy.cpu.register_A, 0x00);
    XCTAssertEqual(gameboy.cpu.flag_Z, 1);
    XCTAssertEqual(gameboy.cpu.flag_N, 0);
...
-(void)test_CP_iHL__Z0 {
    Gameboy gameboy;
    std::array<Byte, 1> program = { 0xBE };
    gameboy.memory.load_rom(program);
    gameboy.cpu.register_A = 0xFF;
    gameboy.cpu.register_H = 0xC0;
    gameboy.cpu.register_L = 0xAB;
    gameboy.memory.write(0xC0AB, 0x05);
    gameboy.run(3);
    XCTAssertEqual(gameboy.cpu.flag_Z, 0);
    XCTAssertEqual(gameboy.cpu.flag_N, 1);
    XCTAssertEqual(gameboy.cpu.flag_H, 1);
...
-(void)test_CP_iHL__Z1 {
    Gameboy gameboy;
    std::array<Byte, 1> program = { 0xBE };
    gameboy.memory.load_rom(program);
    gameboy.cpu.register_A = 0xFF;
    gameboy.cpu.register_H = 0xC0;
    gameboy.cpu.register_L = 0xCD;
    gameboy.memory.write(0xC0CD, 0xFF);
    gameboy.run(3);
    XCTAssertEqual(gameboy.cpu.flag_Z, 1);
    XCTAssertEqual(gameboy.cpu.flag_N, 1);
    XCTAssertEqual(gameboy.cpu.flag_H, 0);
...
-(void)test_POP_BC {
    Gameboy gameboy;
    std::array<Byte, 3> program = { 0xC1 };
    gameboy.memory.load_rom(program);
    gameboy.cpu.stack_pointer = 0xE000 - 2;
    gameboy.memory.write(0xE000 - 1, 0xBA);
    gameboy.memory.write(0xE000 - 2, 0xAB);
    gameboy.run(4);
    XCTAssertEqual(gameboy.cpu.register_B, 0xBA);
    XCTAssertEqual(gameboy.cpu.register_C, 0xAB);
